...
// Controlador para manejar la subida de imágenes (modificado para pruebas)
const uploadImage = async (req, res) => {
    console.log('Archivos recibidos:', req.file); // Verificar si el archivo está presente
    ...
    // Aquí puedes devolver una respuesta simple confirmando que el archivo fue recibido
    res.status(200).send({
